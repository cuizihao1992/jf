...
class HomePage extends LitElement {
  ...
  firstUpdated() {
    ...
    // 初始化地图
    mapboxgl.accessToken = 'pk.eyJ1IjoiaG9uZ2xpbmdqaW4xOTk0IiwiYSI6ImNrczhvZTNmbDN0ZnEycHM3aTkyanp3NmsifQ.iCdeT5IE9GlGKmExl0U6zA'; // 替换为你的 token
      ...
      const setChineseLabels = () => {
        ...
        labelLayers.forEach(layer => {
          if (map.getLayoutProperty(layer.id, 'text-field')) {
            map.setLayoutProperty(layer.id, 'text-field', ['coalesce', ['get', 'name_zh'], ['get', 'name']]);
          }
        });
      };
        ...
        ? html`
            <div class="header">
             <div class="header-left">
              <div>${this.currentLocation} &nbsp;&nbsp;&nbsp; 时间：${this.currentTime}</div>
            </div>
            <div class="header-center">测试</div>
            <div style="width: 200px"></div> <!-- 用于平衡布局的空div -->
          </div>
