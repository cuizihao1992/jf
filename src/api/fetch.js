  ...
  fetchData(endpoint, method = 'GET', params = null) {
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization:
          'Bearer eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjcwZTVjNzk3LTAyMDUtNDhhZi05YjE3LTAyZjM5ZGU5M2M2NSJ9.t2A-86EigBhiZCZbejZmVXVLLjDPmD3UaGwxPcFcArwIZlu8SV49kcMyHlSKkBNIr1vzqspMXrxyJ2lu-H6rHA',
        Cookie:
